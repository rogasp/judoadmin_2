        ...
        return [
            ...
            Events\TenantCreated::class => [
                JobPipeline::make([
                    ...
                    return $event->tenant;
                })->shouldBeQueued(config('tenancy.create_tenant_job_qued') || false), // `false` by default, but you probably want to make this `true` for production.
            ],
